...
2. **Content folders** (`calendar/`, `career/`, `documents/`, `finance/`,
   `health/`, `internet/`, `manual/`, `media/`, `social/`, `statistics/`) -
   filename sanitization without spaces **and** rewrite of all markdown
   references to those files (Step 2).
...
1. Target folders (unless the user names specific paths): `calendar/`,
   ...
   `media/`, `social/`, `statistics/`. Skip `.audit/`.
